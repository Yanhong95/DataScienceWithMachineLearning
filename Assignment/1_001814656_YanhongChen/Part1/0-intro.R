...
## A: 5 years of computer science learning experience and half year paid full-stack engineer inter experience.
...
## A: how to use cor() ? could you provide some specified example?
